...
<head>
    ...
    <title>Perfect Concierge - Modifier une réservation</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h2>Réservation</h2>
        <p class="lead">Modifier une réservation</p>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 order-md-2 mb-4">
            ...
            <form class="form-check"
                  method="post"
                  action="check/modify.php?page=<?php echo $_GET['page']?>&id=<?php echo $_GET['id']?>"
            >
                <ul class="list-group mb-3">
                    ...
                    switch ($_GET['page']){
                        case 1:
                            $bookdata = $database->find('SELECT address, cast(datetime as date), cast(datetime as time), quantity_booked, customer_id FROM booking WHERE id = ?', [$_GET['id']]);
                            $subData = $database->find('SELECT * FROM subscription WHERE customer_id = ?', [$bookdata['customer_id']]);
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date"
                                           ...
                                           name="inputDate"
                                           id="inputDate"
                                           value="'.$bookdata['cast(datetime as date)'].'"
                                           required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="time"
                                           ...
                                           name="inputTime"
                                           id="inputTime"
                                           value="'.$bookdata['cast(datetime as time)'].'"
                                           required>
                                </div>
                            </div>
                        ';
