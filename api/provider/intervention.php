    ...
    <div class="row">
        <div class="col-md-12 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <?php
                $bookdata = $database->getPdo()->query("SELECT * FROM booking WHERE provider_id='".$userData['id']."'");
                foreach ($bookdata as $booking) {
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">
                                <a href="check/refuse.php?id=<?php echo $booking['id'];?>" class="btn btn-danger">X</a>
                            </span>
                    </li>
                    <?php
                }
